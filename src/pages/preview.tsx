...
// TODO: move Hook for time interval to another file
  ...
  const updateContent = () => {
    const fetchData = async () => {
      ...
      const response = await fetch(
        `https://nardi87--storecomponents.myvtex.com/_v/admin-cms-graphql-rc/v0/contentVariant?variantId=${contentVariantId}`
      )
